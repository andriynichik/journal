...
try:
	...
	dError = eval(str(e))
	print ("ClientSessionCreateStep1 failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("ServerSessionCreateStep1 failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("ClientSessionCreateStep2 failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("ServerSessionCreateStep2 failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("SessionIsInitialized failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("SessionEncrypt failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("SessionDecrypt failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
...
try:
	...
	dError = eval(str(e))
	print ("SessionDestroy failed. Error code: " + str(dError['ErrorCode']) + ". Description: " + dError['ErrorDesc'])
	pIface.Finalize()
	EUUnload()
	exit()
