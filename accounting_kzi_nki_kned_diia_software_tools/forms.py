...
from .models import Accounting_KZI_NKI_KNED_DIIA_SOFTWARE_TOOLS, TOOL_KZI_CHOICE, NKI_TYPE_CHOICE

class Accounting_KZI_NKI_KNED_DIIA_SOFTWARE_TOOLSForm(forms.ModelForm):
    ...
    class Meta:
        model = Accounting_KZI_NKI_KNED_DIIA_SOFTWARE_TOOLS
