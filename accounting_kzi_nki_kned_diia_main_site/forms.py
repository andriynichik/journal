...
from .models import Accounting_KZI_NKI_KNED_DIIA_MAIN_SITE, TOOL_KZI_CHOICE, NKI_TYPE_CHOICE

class Accounting_KZI_NKI_KNED_DIIA_MAIN_SITEForm(forms.ModelForm):
    ...
    class Meta:
        model = Accounting_KZI_NKI_KNED_DIIA_MAIN_SITE
