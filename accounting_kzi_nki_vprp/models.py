...
class Accounting_KZI_NKI_VPRP(models.Model):
    ...
    inverter_numbers_peom =  models.CharField(max_length=128, blank=True, null=True)
    accounting_kzi_nki_sign = models.ForeignKey(SignInvate, on_delete=models.SET_NULL, related_name='accounting_kzi_nki_vprp_sign', null=True)
    get_remedy_kzi_nki_sign = models.ForeignKey(SignInvate, on_delete=models.SET_NULL, related_name='get_remedy_kzi_nki_vprp_sign', null=True)
    note_return_means_sign = models.ForeignKey(SignInvate, on_delete=models.SET_NULL, related_name='note_return_means_vprp_sign', null=True)
