...
class Accounting_KZI_NKI_KNED_DIIA_COLD_RESERVE(models.Model):
    ...
    accounting_kzi_nki_sign = models.ForeignKey(SignInvate, on_delete=models.CASCADE, related_name='accounting_kzi_nki_sign_cold_reserve', null=True)
    get_remedy_kzi_nki_sign = models.ForeignKey(SignInvate, on_delete=models.CASCADE, related_name='get_remedy_kzi_nki_sign_cold_reserve', null=True)
    note_return_means_sign = models.ForeignKey(SignInvate, on_delete=models.CASCADE, related_name='note_return_means_sign_cold_reserve', null=True)
