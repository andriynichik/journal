...
from .models import Accounting_KZI_NKI_KNED_DIIA_RESERVE_SITE, TOOL_KZI_CHOICE, NKI_TYPE_CHOICE

class Accounting_KZI_NKI_KNED_DIIA_RESERVE_SITEForm(forms.ModelForm):
    ...
    tool_kzi_number = forms.IntegerField(
        ...
        widget=forms.TextInput(
            attrs={
                ...
                "pattern" : "\d*",
                "oninvalid" : "setCustomValidity('Значення має бути числом')",
    ...
    class Meta:
        model = Accounting_KZI_NKI_KNED_DIIA_RESERVE_SITE
