...
class Accounting_KZI_NKI_KNED_DIIA(models.Model):
    ...
    accounting_kzi_nki_sign = models.ForeignKey(SignInvate, on_delete=models.CASCADE, related_name='accounting_kzi_nki_sign', null=True)
    get_remedy_kzi_nki_sign = models.ForeignKey(SignInvate, on_delete=models.CASCADE, related_name='get_remedy_kzi_nki_sign', null=True)
    note_return_means_sign = models.ForeignKey(SignInvate, on_delete=models.CASCADE, related_name='note_return_means_sign', null=True)
